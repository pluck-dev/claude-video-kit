...
## 실행 절차
1. {VIDEO}/scripts/ 폴더에서 스크립트 읽기
2. 씬별 레이아웃 테이블 생성
3. ASCII 스케치 작성
4. 프레임 계산 (FPS 기반)
5. 트랜지션 지정
6. Remotion 컴포넌트 매핑
7. {VIDEO}/storyboard/ 에 md 파일 생성

## 출력
- `{VIDEO}/storyboard/scene-{N}.md` — 씬별 스토리보드
- `{VIDEO}/storyboard/overview.md` — 전체 타임라인 개요
- {VIDEO}/VIDEO.md Phase 1c 상태 업데이트
